...
select * from grievance_lifecycle gl where gl.grievance_id = 3105657;
select * from grievance_master gm where gm.grievance_id = 38806;
   
select * from admin_position_master apm ;
select * from admin_user_role_master aurm ;
     
      -- back track --
select * from admin_user_position_mapping aupm where aupm.position_id = 1176;
select * from admin_user_details aud where aud.admin_user_id = 12630;
select * from admin_user au where au.admin_user_id = 12630;
select * from admin_position_master apm where apm.position_id = 1176;
