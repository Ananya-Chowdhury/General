...
-- ==========================================================
-- 10. Restore the identity/sequence.
-- ==========================================================
ALTER TABLE citizen
ALTER COLUMN id
...
-- ==========================================================
-- 11. Always run sequence reset after data migration:
-- ==========================================================
SELECT setval(pg_get_serial_sequence('public.citizen','id'), (SELECT MAX(id) FROM public.citizen));
SELECT setval(pg_get_serial_sequence('public.citizen_address','id'), (SELECT MAX(id) FROM public.citizen_address));
SELECT setval(pg_get_serial_sequence('public.service_request','id'), (SELECT MAX(id) FROM public.service_request));
SELECT setval(pg_get_serial_sequence('public.service_request_lifecycle','id'), (SELECT MAX(id) FROM public.service_request_lifecycle));
SELECT setval(pg_get_serial_sequence('public.service_review','id'), (SELECT MAX(id) FROM public.service_review));



-- ==========================================================
-- 12. Reset the Identity Sequence Manual
-- ==========================================================
SELECT setval(
...
SELECT pg_get_serial_sequence('public.service_request','id');
SELECT last_value FROM public.service_request_id_seq;
