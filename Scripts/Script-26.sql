...
select * from grievance_master gm where gm.grievance_no in ('SSM5341070','SSM5341071', 'SSM5341073');
select * from grievance_lifecycle gl where gl.grievance_id in (22952
,22953)
