...
CREATE OR REPLACE FUNCTION public.cmo_grievance_counts_age(ssm_id integer, dept_id integer)
 ...
 recalled bigint, returned bigint, grievances_recieved bigint, atr_pending bigint, pending_grievance bigint, age_below_18 bigint, age_18_30 bigint, 
 age_31_45 bigint, age_46_60 bigint, age_above_60 bigint, age_below_18_percentage bigint, age_18_30_percentage bigint, age_31_45_percentage bigint, 
 age_46_60_percentage bigint, age_above_60_percentage bigint, age_below_18_male bigint, age_below_18_female bigint, age_18_30_male bigint, 
 age_18_30_female bigint, age_31_45_male bigint, age_31_45_female bigint, age_46_60_male bigint, age_46_60_female bigint, age_above_60_male bigint, 
...
-- DROP FUNCTION public.cmo_grievance_counts_area(int4, int4);

CREATE OR REPLACE FUNCTION public.cmo_grievance_counts_area(ssm_id integer, dept_id integer)
 RETURNS TABLE(district_id bigint, district_name bigint, atr_recevied_count bigint, atr_pending_count bigint, returned bigint, grievances_recieved bigint, atr_pending bigint,
