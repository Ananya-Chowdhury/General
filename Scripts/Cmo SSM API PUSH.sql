...
---- Total Data Count ----------->>>>>>>>
SELECT * from public.cmo_ssm_api_push_data_count_v2('2025-11-17');
...
--			and gl.assigned_on::DATE = '2025-10-15'::DATE
			and gl.assigned_on::DATE between '2024-11-12'::DATE and '2025-11-05'::DATE
...
where cspd.actual_push_date::date = '2025-11-16'    ---2025-11-06, 2025-11-07, 2025-11-08, 2025-11-09, 2025-11-10
...
--where gl.assigned_on::date = '2025-11-05'::DATE
where gl.assigned_on::date between '2024-11-12' and '2025-11-05'
