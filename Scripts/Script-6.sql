...
CREATE OR REPLACE FUNCTION public.cmo_grievance_counts_age(ssm_id integer, dept_id integer)
 ...
 age_46_60_percentage bigint, age_above_60_percentage bigint, age_below_18_male bigint, age_18_30_male bigint, age_31_45_male bigint, age_46_60_male bigint, 
 age_above_60_male bigint, age_below_18_female bigint, age_18_30_female bigint, age_31_45_female bigint, age_46_60_female bigint, age_above_60_female bigint)
 LANGUAGE plpgsql
AS $function$
	BEGIN
		if dept_id > 0 then
